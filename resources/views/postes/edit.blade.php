    ...
    <x-posts-card>
        ...
        <form action="{{ route('postes.update', $poste->id) }}" method="post">
            ...
            <select name="experience_id"
                ...
                <option value="{{ $poste->experience_id }}" {{ $poste->experience_id === $poste->experience_id  ? 'selected':''}}>{{ $experience->label_experience }}</option>
                @endforeach
            </select>
            ...
            <select name="diplome_id"
                ...
                <option value="{{ $poste->diplome_id}}"{{ $poste->diplome_id === $diplome->id ? 'selected':'' }}>{{ $diplome->label_diplome }}</option>
                @endforeach
            </select>
